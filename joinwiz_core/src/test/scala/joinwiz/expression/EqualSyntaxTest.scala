...
class EqualSyntaxTest extends AnyFunSuite with Matchers {
  ...
  test("left T and left T can equal") {
    ...
    evaluated().toString() should be("(LEFT.pk = LEFT.pk)")
  }
  ...
  test("left T and left opt T can equal") {
    ...
    evaluated().toString() should be("(LEFT.pk = LEFT.opt)")
  }
  ...
  test("left T and const T can equal") {
    ...
    evaluated().toString() should be("(LEFT.pk = matching)")
  }
  ...
  test("right T and right T can equal") {
    ...
    evaluated().toString() should be("(RIGHT.pk = RIGHT.pk)")
  }
  ...
  test("right T and right opt T can equal") {
    ...
    evaluated().toString() should be("(RIGHT.pk = RIGHT.opt)")
  }
  ...
  test("right T and const T can equal") {
    ...
    evaluated().toString() should be("(RIGHT.pk = matching)")
  }
  ...
  test("left opt T and left T can equal") {
    ...
    evaluated().toString() should be("(LEFT.opt = LEFT.pk)")
  }
  ...
  test("left opt T and left opt T can equal") {
    ...
    evaluated().toString() should be("(LEFT.opt = LEFT.opt)")
  }
  ...
  test("left opt T and const T can equal") {
    ...
    evaluated().toString() should be("(LEFT.opt = matching)")
  }
  ...
  test("right opt T and right T can equal") {
    ...
    evaluated().toString() should be("(RIGHT.opt = RIGHT.pk)")
  }
  ...
  test("right opt T and right opt T can equal") {
    ...
    evaluated().toString() should be("(RIGHT.opt = RIGHT.opt)")
  }
  ...
  test("right opt T and const T can equal") {
    ...
    evaluated().toString() should be("(RIGHT.opt = matching)")
  }
