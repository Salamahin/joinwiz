...
trait LowLevelCompareSyntax {
  ...
  abstract class BasicLTColCompareSyntax[F[_], L, R, T: Ordering](thisCol: LTCol[L, R, F[T]])(implicit op: TColOps[F]) {
    ...
    def <=(thatCol: LTColW[L, R, T]): Expr[L, R]    = expr[L, R]((l, _) => op.compare(thisCol(l), thatCol.wrapped(l))(-1, 0))(thisCol.column <= thatCol.wrapped.column)
    def <=(thatCol: RTColW[L, R, T]): Expr[L, R]    = expr[L, R]((l, r) => op.compare(thisCol(l), thatCol.wrapped(r))(-1, 0))(thisCol.column <= thatCol.wrapped.column)
  ...
  abstract class BasicRTColCompareSyntax[F[_], L, R, T: Ordering](thisCol: RTCol[L, R, F[T]])(implicit op: TColOps[F]) {
    ...
    def <=(thatCol: LTColW[L, R, T]): Expr[L, R]    = expr[L, R]((l, r) => op.compare(thisCol(r), thatCol.wrapped(l))(-1, 0))(thisCol.column <= thatCol.wrapped.column)
    def <=(thatCol: RTColW[L, R, T]): Expr[L, R]    = expr[L, R]((_, r) => op.compare(thisCol(r), thatCol.wrapped(r))(-1, 0))(thisCol.column <= thatCol.wrapped.column)
