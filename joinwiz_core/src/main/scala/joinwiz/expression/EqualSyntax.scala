...
trait LowLevelEqualSyntax {
  ...
  abstract class BasicColEqualSyntax[F[_], L, R, T](thisCol: TColumn[L, R, F[T]])(implicit op: TColumnCompare[F]) {
  ...
  implicit class LTColEqualSyntax[L, R, T](thisCol: LTColumn[L, R, T]) extends BasicColEqualSyntax[Id, L, R, T](thisCol)
  implicit class RTColEqualSyntax[L, R, T](thisCol: RTColumn[L, R, T]) extends BasicColEqualSyntax[Id, L, R, T](thisCol)
}

trait EqualSyntax extends LowLevelEqualSyntax {
  implicit class OptionalLTColEqualSyntax[L, R, T](thisCol: LTColumn[L, R, Option[T]]) extends BasicColEqualSyntax[Option, L, R, T](thisCol)
  implicit class OptionalRTColEqualSyntax[L, R, T](thisCol: RTColumn[L, R, Option[T]]) extends BasicColEqualSyntax[Option, L, R, T](thisCol)
}
