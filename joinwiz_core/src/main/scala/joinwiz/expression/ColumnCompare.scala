...
object ColumnCompare {
  ...
  implicit val compareOfOptionTCol: ColumnCompare[Option] = new ColumnCompare[Option] {
  ...
  implicit val compareOfIdTCol: ColumnCompare[Id] = new ColumnCompare[Id] {
